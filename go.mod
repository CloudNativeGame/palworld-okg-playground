module github.com/CloudNativeGame/palworld-okg-playground

go 1.21

require (
	github.com/alibabacloud-go/cs-20151215/v4 v4.0.3
	...
	github.com/openkruise/kruise v1.5.2
	github.com/openkruise/kruise-api v1.5.0
	github.com/openkruise/kruise-game v0.7.0
